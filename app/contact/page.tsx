      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '40px 48px', position: 'relative', zIndex: 1 }}>
        <div style={{ maxWidth: 640 }}>
          <div style={{ marginBottom: 32 }}>
            <h1 style={{ fontSize: 24, fontWeight: 800, color: '#0f172a', margin: '0 0 8px' }}>联系运维</h1>
            <p style={{ fontSize: 14, color: '#64748b', margin: 0 }}>遇到技术问题请通过以下方式联系运维团队</p>
          </div>

          {/* Main contact card */}
          <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e2e8f0', padding: '32px', marginBottom: 20, boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
              <div style={{ width: 56, height: 56, background: '#dbeafe', borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <svg style={{ width: 28, height: 28, color: '#2563eb' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </div>
              <div>
                <div style={{ fontSize: 13, fontWeight: 500, color: '#64748b', marginBottom: 4 }}>运维热线</div>
                <div style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', letterSpacing: '0.05em' }}>198 5162 2265</div>
              </div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              {[
                ...
                <div key={label} style={{ background: '#f8fafc', borderRadius: 10, padding: '12px 16px' }}>
                  ...
                  <div style={{ fontSize: 14, fontWeight: 500, color: '#374151' }}>{value}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{ background: '#fff', borderRadius: 14, border: '1px solid #e2e8f0', padding: '24px', marginBottom: 20 }}>
            <h3 style={{ fontSize: 15, fontWeight: 700, color: '#0f172a', margin: '0 0 16px' }}>运维支持范围</h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <div key={text} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 14px', background: '#f8fafc', borderRadius: 9 }}>
